# -*- encoding: utf-8 -*-
# stub: shopify_app 7.0.11 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<shopify_api>.freeze, ["~> 4.2.2"])
    s.add_runtime_dependency(%q<omniauth-shopify-oauth2>.freeze, ["~> 1.1.11"])
    ...
    s.add_dependency(%q<shopify_api>.freeze, ["~> 4.2.2"])
    s.add_dependency(%q<omniauth-shopify-oauth2>.freeze, ["~> 1.1.11"])
